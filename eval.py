...
parser.add_argument('--use_bbox2d', action='store_true', help='Using 2d bounding box as input.')
...
num_input_channel = int(FLAGS.use_color)*3 + int(not FLAGS.no_height)*1 + int(FLAGS.use_bbox2d)*10
